...
function showImages()
{
	...
	for(var i=0;i<currentData.data.length;i++)
	{
		...
		//html+='<a href="javascript:void(0)" class="icon-font icon-22-download"></a> '
			...
			+rf+' <br/>'+item.corbisId+'<br/><a href="javascript:void(0)">'+item.scn+'</a>   /   <a href="photocollection/'+item.collectionName+'" target="_blank" cid="'+item.collectionId+'">'+item.collectionName+'</a><br/>';
