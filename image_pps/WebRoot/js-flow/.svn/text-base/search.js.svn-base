			...
			functionBefore: function(origin, continueTooltip) {
				...
				if (origin.data('ajax') !== 'cached') {
					...
					$.ajax({
						...
						dataType:'json',
						url: ajaxUrl_toolTip,
						//data:{'imgId':origin.find('img').attr('imgId'), 'imgLightBoxedClass':imgLightBoxedClass},
						...
						success: function(data) {
							...
							if(data.status == 1)
							{
								htmlData='<div class="picDetailWrap '+data.imgLightBoxedClass+'"><div class="imgWrap"><img src="images/search/popup.jpg" imgId="'+data.imgId+'"/></div><div class="picCont"><div class="tag"><span>RM</span>创意类</div><div class="header">图片的短名字</div><div class="picInfo">图片编号: 204023333<br/>摄影师   Andrew Alderson<br/>专辑名字  Blink <br/></div><a href="#" class="btnPurple btnShopCart btn-block">加购物车</a><div class="btnWrap iconWrap"><a href="javascript:void(0)" class="icon-font icon-22-download"></a><a href="javascript:void(0)" class="icon-font icon-11-favourite"></a><a href="javascript:void(0)" class="icon-font icon-29-search2"></a></div></div></div>';	
