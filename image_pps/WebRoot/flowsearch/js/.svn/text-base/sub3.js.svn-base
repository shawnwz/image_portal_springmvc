(function ($) {
    jQuery(document).ready(function () {
        ...
        $('.image_slide_content ul').click(function(){
		...
		$('.return li img').removeClass('active_thumb');
...
/*3*/                    $('.asideRight').removeClass('unactiveButton');
                } else {
                ...
                $('.image_slide_content li').css('opacity', '.3');
        ...
        $('.button_collection_details').click(function () {
            ...
            $('#toggleButton_gallery').toggleText('更多影展', '关闭');
        });
        ...
        function imageSetDetail( icount ) {
            ...
            //setTimeout(function(){
             //   document.title=icount;
                ...
                $('.image_slide_content ul li img').height(heightTotal - 20);
