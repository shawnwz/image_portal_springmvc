...
if (currentEnvironment == 'PROD') {
    var s_account = "corbismonarchcom"
}
else {
...
s.linkInternalFilters = "javascript:,corbis.com,corbispro.com,corbis.fi,.corbis.com,pro.corbis.com,/corbis.com,.corbispro.com,/corbispro.com,corbisimages.com,/pro.corbis.com,.pro.corbis.com,.corbisimages.com,/corbisimages.com,.corbis.fi,/corbis.fi,pro.corbisimages.com,secure.corbis.com,secure.corbisimages.com,zoom.corbis.com"
...
function s_doPlugins(s) {
    ...
    s.campaign = s.getQueryParam('cid,s_kwcid',':'); //remove comments and replace cid or s_kwcid with campaign query parameter
    s.campaign = s.getValOnce(s.campaign, 's_campaign', 30);

    // track redirected referring links when the query parameter 'ref' is used to store the original referring URL
    if (s.getQueryParam('ref')) { s.referrer = s.getQueryParam('ref'); }
