...
<meta property="qc:admins" content="244101466767170161517536375" />
...
<link href="flowsearch/css/index_automobile.css" rel="stylesheet" type="text/css" />
	...
	<div id="homeBanner">
		...
		<div class="bannerWrap autoRotate">
			<div class="bannerImgWrap">
		        ...
		        <div class="bannerImg">		
		            <img src="webres/upload/${item.path}" width="1920" height="670"/>
		            <div class="label Source-Han-Light hidden-xs hidden-sm"><a href="http://gaopinimages.com/image/${item.gaopinId}">${item.memo}</a> 
					<a href="${item.link}">${item.linkName}</a></div>
		        </div>
		        </c:forEach>
			</div>
			...
			<div class="searchBar">
				<div class="container">
					<div class="searchBarInner col-md-9">
						...
						<a href="search#" class="btnSearch icon-font icon-13-search"></a>
					</div>
				</div>
			</div>
		...
		<c:choose>
			<c:when test="${questionType eq 1}">
				<div class="row row1 hidden-xs">
					<div class="col-md-12">
						<a href="${questionIUrl }" id="ad1" class="box_top">
			...
			<c:otherwise>
				<div class="row row1 hidden-xs">
					 ...
					 <div class="col-md-8 Source-Han-Light ppp">				    
						 <a href="photostock761" id="ad2" class="box_top">
							<img src="images/automobile.png">
							<div class="carbg">
						       	<div class="carbg_font1">
								    <span class="carbg_font1_top">360°</span>
								    <span class="carbg_font1_center">HDRI</span>
								    <span class="carbg_font1_bottom">高清背景</span>
								</div>
							</div>
							<div class="carbg">
							    <div class="carbg_font2">
								    <span class="carbg_font2_top">专为汽车震撼上线,</span><br>
								    <span class="carbg_font2_center">呈现多样地貌,</span><br>
									<span class="carbg_font2_bottom">任意角度，每一缕光!</span>
								</div>
							</div>
							<div class="carbg">
							    <div class="carbg_font3"></div>
							        <span class="carbg_font3_center">马上搜索:汽车背景</span>
					...
					<div class="col-md-4 hidden-sm">
						<a href="${questionIIUrl }" id="ad3" class="box_top">
			...
			<div class="tab-content row">
				...
				<div class="tab-pane" id="tab2">
					...
					<div class="col-md-4 col-sm-4 column">
						...
						<a href="photostock661" class="boxCollectionMore hidden-sm hidden-xs">
