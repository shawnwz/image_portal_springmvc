			...
			<c:forEach items="${imglist}" var="img" varStatus="stat">
				<div class="oneMobileInfo">
	                <div class="leftMobileInfo">
	                    <img src="${img.imageHost }THUMBNAIL/180/${img.path}${img.ext}" alt=""/>
	                </div>
...
<%-- 	                <ul class="buttonMobileInfo">
		...
		<button class="mobileCollection">更多专辑 </button>
		...
		<div class="image_slide">
			...
			<div class="image_slide_content">
				...
				<ul>
				<c:forEach items="${imglist}" var="img" varStatus="stat">
					<li><a href="imagesflow/${img.corbisId}"><img src="imagesetsview/${item1.id}/${img.corbisId}${img.ext}" alt=""></a>></li>
				</c:forEach>
				</ul>
			</div>
		</div>
					...
					<div class="content_thumb">
						...
						<c:forEach items="${imglist}" var="img" varStatus="stat">
							<c:choose>
							 <c:when test="${stat.index==0}">
                              	<li>
								<img src="${img.imageHost }THUMBNAIL/180/${img.path}${img.ext}" alt="" class="active_thumb">
						...
						<c:forEach items="${map[item.id]}" var="subitem" varStatus="stat">
								...
								<div class="left_collection">
										<a href="imgsets${subitem.id}">
											...
											<img src="webres/upload/${subitem.imageSetSrc}" width="120" alt="" />
										</a>
		...
		<button class="button_collection_details"><span class="buttonSpan"></span><span id="toggleButton">更多专题</span></button>
	</div>
</div>
<!-- InstanceEndEditable -->
