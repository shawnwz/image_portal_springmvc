...
<div id="sectionCont" class="pageLanding">
    ...
    <div class="container editorialLanding landingPages">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="landingPagesTitle">
                    <h1 class="Source-Han-Light"><span class="gaopinIcon gaopinIcon-History"></span>${item_overview.title}</h1>
                    ${item_overview.info}
                </div>
            </div>
            <div class="col-md-8">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div>
                    <a href="${item_img_2.url }" class="boxCollection no_margin_links">
                ...
                <div>
                    <a href="${item_img_3.url}" class="boxCollection no_margin_links">
            ...
            <div class="col-md-6">
                <div>
                    <a href="${item_img_4.url}" class="boxCollection no_margin_links highest">
