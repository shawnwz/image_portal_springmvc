...
/**
 * TubeOrgiImages generated by hbm2java
 */
@Entity
@Table(name = "tube_orgi_images")
public class TubeOrgiImages implements java.io.Serializable {
	...
	public TubeOrgiImages() {
	}

	public TubeOrgiImages(int isInImageGroup, int deleted, int requestonline,
			int imageusage, int isexclusive) {
	...
	public TubeOrgiImages(String uuid, Integer filesize, String orgiFilename,
			String filename, String storageid, String userid, String title,
			...
			String reason, String metadata, Integer voteUp, Integer voteDown,
			...
			int requestonline, String copyrightid, String modelreleaseids,
			String propertyreleaseids, int imageusage, int isexclusive) {
		this.uuid = uuid;
	...
	@Column(name = "requestonline", nullable = false)
	...
	@Column(name = "copyrightid", length = 10)
	...
	@Column(name = "modelreleaseids", length = 100)
	...
	@Column(name = "propertyreleaseids", length = 100)
	...
	@Column(name = "imageusage", nullable = false)
